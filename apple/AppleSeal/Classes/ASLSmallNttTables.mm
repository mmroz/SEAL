...
@implementation ASLSmallNttTables {
    seal::util::NTTTables * _smallNttTables;
    BOOL _freeWhenDone;
}
...
+ (instancetype)smallNttTablesWithPool:(ASLMemoryPoolHandle *)pool {
    auto table = seal::util::NTTTables(pool.memoryPoolHandle);
...
+ (instancetype)smallNttTablesWithCoefficentCountPower:(int)coefficentCountPower smallModulus:(ASLSmallModulus *)smallModulus pool:(ASLMemoryPoolHandle *)pool {
    auto table = seal::util::NTTTables(coefficentCountPower, smallModulus.smallModulus, pool.memoryPoolHandle);
    return [[ASLSmallNttTables alloc] initWithSmallNttTables:&table freeWhenDone:YES];
}

+ (instancetype)smallNttTablesWithCoefficentCountPower:(int)coefficentCountPower smallModulus:(ASLSmallModulus *)smallModulus {
    auto table = seal::util::NTTTables(coefficentCountPower, smallModulus.smallModulus);
    
    return [[ASLSmallNttTables alloc] initWithSmallNttTables:&table freeWhenDone:YES];
}

- (instancetype)init {
    auto table = seal::util::NTTTables();
    return [[ASLSmallNttTables alloc] initWithSmallNttTables:&table freeWhenDone:YES];
}
...
- (instancetype)initWithSmallNttTables:(seal::util::NTTTables *)smallNttTables freeWhenDone:(BOOL)freeWhenDone{
    self = [super init];
    if (self == nil) {
        return nil;
    }
